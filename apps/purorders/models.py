...
class PurchaseOrder(models.Model):
    ...
    po_cost_value = models.DecimalField(max_digits=14, decimal_places=2, default=0.00)
    po_unit_cost = models.DecimalField(max_digits=14, decimal_places=2, default=0.00)
    po_charge_value = models.DecimalField(max_digits=14, decimal_places=2, default=0.00)
    po_unit_charge = models.DecimalField(max_digits=14, decimal_places=2, default=0.00)
