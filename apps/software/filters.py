...
class SoftwareFilter(django_filters.FilterSet):
    ...
    sw_description = CharFilter(field_name='sw_description', lookup_expr='icontains', label='Software Product', widget=TextInput(attrs={'placeholder': 'Product name contains...'}))
    sw_version = CharFilter(field_name='sw_version', lookup_expr='icontains', label='Software Version', widget=TextInput(attrs={'placeholder': 'Version contains...'}))
    class Meta:
        model = Software
        fields = {
            'sw_vend_fk',
