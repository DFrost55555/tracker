...
class ItemType(models.Model):
    ...
    itmtype_name = models.CharField('item type name', max_length=100)
...
class Item(models.Model):
    ...
    itm_item_type_fk = models.ForeignKey(ItemType, verbose_name='item type fk', on_delete=models.SET_NULL, null=True)
