...
class INVType(models.Model):
    ...
    invtyp_description = models.CharField(
        'inv type description', max_length=2000)
    invtyp_createdby = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True)
    invtyp_createddate = models.DateTimeField(default=timezone.now)
    invtyp_modifiedby = models.ForeignKey(
        User, related_name='invtyp_editor', on_delete=models.SET_NULL, null=True)
...
class Invoice(models.Model):
    ...
    inv_quantity = models.DecimalField(
        'invoice quantity number', max_digits=10, decimal_places=2)
    inv_quantity_type_fk = models.ForeignKey(
        ChargeUnitType, verbose_name='invoice quantity type', on_delete=models.SET_NULL, null=True)
    inv_cost_value = models.DecimalField(
        'invoice cost value', max_digits=10, decimal_places=2)
    ...
    inv_modifiedby = models.ForeignKey(
        User, related_name='inv_editor', on_delete=models.SET_NULL, null=True)
...
class INVNote(models.Model):
    ...
    invnote_modifiedby = models.ForeignKey(
        User, related_name='invnote_editor', on_delete=models.SET_NULL, null=True)
...
class INVMatrix(models.Model):
    ...
    invmtx_inv_id = models.ForeignKey(
        Invoice, verbose_name='invoice', on_delete=models.SET_NULL, null=True)
    invmtx_po_id = models.ForeignKey(
        PurchaseOrder, verbose_name='purchase order', on_delete=models.SET_NULL, null=True)
    invmtx_project_fk = models.ForeignKey(
        Project, verbose_name='project', on_delete=models.SET_NULL, null=True)
    invmtx_customer_fk = models.ForeignKey(
        Customer, verbose_name="customer", on_delete=models.SET_NULL, null=True)
    invmtx_supplier_fk = models.ForeignKey(
        Supplier, verbose_name="supplier", on_delete=models.SET_NULL, null=True)
    invmtx_approver_fk = models.ForeignKey(
        Approver, verbose_name="approver", on_delete=models.SET_NULL, null=True)
    ...
    invmtx_modifiedby = models.ForeignKey(
        User, related_name='invtx_editor', on_delete=models.SET_NULL, null=True)
