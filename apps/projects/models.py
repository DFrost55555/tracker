...
class Project(models.Model):
    ...
    project_chargecode = models.CharField(max_length=255)
    project_chargecodetype = models.CharField(max_length=25, choices=CHARGE_CODE_CHOICES, default='wbs')
    project_status = models.CharField(max_length=25, choices=STATUS_CHOICES, default='active')
